...
public class ExtendedClassImported extends PreorderJmmVisitor<Integer, Integer> implements SemanticAnalyser {

    private final List<Report> reports;
    private final SymbolTableBuilder symbolTable;

    public ExtendedClassImported(JmmNode root, SymbolTableBuilder symbolTable) {
    ...
    private Integer classVisit(JmmNode classNode, Integer dummy){
        if(classNode.getAttributes().contains("extends")){
            String extendedClass = classNode.get("extends");
            ...
            if(!imports.contains(extendedClass)){
                reports.add(new Report(ReportType.ERROR, Stage.SEMANTIC,
                        ...
                        "Extended from not defined class."));
                return -1;
            }
        }
