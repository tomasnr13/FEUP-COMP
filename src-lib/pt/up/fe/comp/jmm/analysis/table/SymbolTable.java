...
public interface SymbolTable {
    ...
    /**
     * @param list of symbols to search
     * @param name symbol name to search for
     * @return Checks if list of symbols contains a name with given string
     */
    boolean containsName(final List<Symbol> list, final String name);

    /**
     * @return List of the last string of the import statements
     */
    List<String> lastStringImports();
